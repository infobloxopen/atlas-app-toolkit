...
type ArrayOfStringsCondition_Type int32

const (
	ArrayOfStringsCondition_OVERLAPS ArrayOfStringsCondition_Type = 0
	ArrayOfStringsCondition_CONTAINS ArrayOfStringsCondition_Type = 1
)

var ArrayOfStringsCondition_Type_name = map[int32]string{
	0: "OVERLAPS",
	1: "CONTAINS",
}

var ArrayOfStringsCondition_Type_value = map[string]int32{
	"OVERLAPS": 0,
	"CONTAINS": 1,
}

func (x ArrayOfStringsCondition_Type) String() string {
	return proto.EnumName(ArrayOfStringsCondition_Type_name, int32(x))
}

func (ArrayOfStringsCondition_Type) EnumDescriptor() ([]byte, []int) {
...
type Filtering struct {
	...
	//	*Filtering_ArrayOfStringsCondition
...
type Filtering_ArrayOfStringsCondition struct {
	ArrayOfStringsCondition *ArrayOfStringsCondition `protobuf:"bytes,7,opt,name=array_of_strings_condition,json=arrayOfStringsCondition,proto3,oneof"`
}
...
func (*Filtering_ArrayOfStringsCondition) isFiltering_Root() {}
...
func (m *Filtering) GetArrayOfStringsCondition() *ArrayOfStringsCondition {
	if x, ok := m.GetRoot().(*Filtering_ArrayOfStringsCondition); ok {
		return x.ArrayOfStringsCondition
	}
	return nil
}
...
func (*Filtering) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Filtering_ArrayOfStringsCondition)(nil),
	}
}
...
type LogicalOperator struct {
	...
	//	*LogicalOperator_LeftArrayOfStringsCondition
	...
	//	*LogicalOperator_RightArrayOfStringsCondition
...
type LogicalOperator_LeftArrayOfStringsCondition struct {
	LeftArrayOfStringsCondition *ArrayOfStringsCondition `protobuf:"bytes,15,opt,name=left_array_of_strings_condition,json=leftArrayOfStringsCondition,proto3,oneof"`
}
...
func (*LogicalOperator_LeftArrayOfStringsCondition) isLogicalOperator_Left() {}
...
func (m *LogicalOperator) GetLeftArrayOfStringsCondition() *ArrayOfStringsCondition {
	if x, ok := m.GetLeft().(*LogicalOperator_LeftArrayOfStringsCondition); ok {
		return x.LeftArrayOfStringsCondition
	}
	return nil
}
...
type LogicalOperator_RightArrayOfStringsCondition struct {
	RightArrayOfStringsCondition *ArrayOfStringsCondition `protobuf:"bytes,16,opt,name=right_array_of_strings_condition,json=rightArrayOfStringsCondition,proto3,oneof"`
}
...
func (*LogicalOperator_RightArrayOfStringsCondition) isLogicalOperator_Right() {}
...
func (m *LogicalOperator) GetRightArrayOfStringsCondition() *ArrayOfStringsCondition {
	if x, ok := m.GetRight().(*LogicalOperator_RightArrayOfStringsCondition); ok {
		return x.RightArrayOfStringsCondition
	}
	return nil
}
...
func (*LogicalOperator) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*LogicalOperator_LeftArrayOfStringsCondition)(nil),
		...
		(*LogicalOperator_RightArrayOfStringsCondition)(nil),
	}
}
...
// field_path is a reference to a value of a resource of string type
// is_negative is set to true if the condition is negated
...
// ArrayOfStringsCondition represents a condition with string arrays, e.g. field overlaps ['hello','world']
// field_path is a reference to a value of a resource of string array type
// is_negative is set to true if the condition is negated
type ArrayOfStringsCondition struct {
	FieldPath            []string                     `protobuf:"bytes,1,rep,name=field_path,json=fieldPath,proto3" json:"field_path,omitempty"`
	Values               []string                     `protobuf:"bytes,2,rep,name=values,proto3" json:"values,omitempty"`
	Type                 ArrayOfStringsCondition_Type `protobuf:"varint,3,opt,name=type,proto3,enum=infoblox.api.ArrayOfStringsCondition_Type" json:"type,omitempty"`
	IsNegative           bool                         `protobuf:"varint,4,opt,name=is_negative,json=isNegative,proto3" json:"is_negative,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
...
func (m *ArrayOfStringsCondition) Reset()         { *m = ArrayOfStringsCondition{} }
func (m *ArrayOfStringsCondition) String() string { return proto.CompactTextString(m) }
func (*ArrayOfStringsCondition) ProtoMessage()    {}
func (*ArrayOfStringsCondition) Descriptor() ([]byte, []int) {
	return fileDescriptor_7b72dfd3c08d3120, []int{11}
}

func (m *ArrayOfStringsCondition) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ArrayOfStringsCondition.Unmarshal(m, b)
}
func (m *ArrayOfStringsCondition) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ArrayOfStringsCondition.Marshal(b, m, deterministic)
}
func (m *ArrayOfStringsCondition) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ArrayOfStringsCondition.Merge(m, src)
}
func (m *ArrayOfStringsCondition) XXX_Size() int {
	return xxx_messageInfo_ArrayOfStringsCondition.Size(m)
}
func (m *ArrayOfStringsCondition) XXX_DiscardUnknown() {
	xxx_messageInfo_ArrayOfStringsCondition.DiscardUnknown(m)
}

var xxx_messageInfo_ArrayOfStringsCondition proto.InternalMessageInfo

func (m *ArrayOfStringsCondition) GetFieldPath() []string {
	if m != nil {
		return m.FieldPath
	}
	return nil
...
func (m *ArrayOfStringsCondition) GetValues() []string {
	if m != nil {
		return m.Values
	}
	return nil
...
func (m *ArrayOfStringsCondition) GetType() ArrayOfStringsCondition_Type {
	if m != nil {
		return m.Type
	}
	return ArrayOfStringsCondition_OVERLAPS
}

func (m *ArrayOfStringsCondition) GetIsNegative() bool {
	if m != nil {
		return m.IsNegative
	}
	return false
...
func (*Searching) Descriptor() ([]byte, []int) {
	return fileDescriptor_7b72dfd3c08d3120, []int{14}
}
...
func init() {
	...
	proto.RegisterEnum("infoblox.api.ArrayOfStringsCondition_Type", ArrayOfStringsCondition_Type_name, ArrayOfStringsCondition_Type_value)
	...
	proto.RegisterType((*ArrayOfStringsCondition)(nil), "infoblox.api.ArrayOfStringsCondition")
...
var fileDescriptor_7b72dfd3c08d3120 = []byte{
	...
	,
}
